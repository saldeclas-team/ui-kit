...
import { DEFAULT_LIGHT_DIVIDER_COLORS, DEFAULT_DARK_DIVIDER_COLORS } from "./divider";
import { DEFAULT_LIGHT_SPINNER_COLORS, DEFAULT_DARK_SPINNER_COLORS } from "./spinner";
import { DEFAULT_LIGHT_AVATAR_COLORS, DEFAULT_DARK_AVATAR_COLORS } from "./avatar";
import { DEFAULT_LIGHT_BADGE_COLORS, DEFAULT_DARK_BADGE_COLORS } from "./badge";
import {
  DEFAULT_LIGHT_PROGRESS_BAR_COLORS,
  DEFAULT_DARK_PROGRESS_BAR_COLORS,
} from "./progress-bar";
import { DEFAULT_LIGHT_DIALOG_COLORS, DEFAULT_DARK_DIALOG_COLORS } from "./dialog";
import { DEFAULT_LIGHT_SLIDER_COLORS, DEFAULT_DARK_SLIDER_COLORS } from "./slider";
import {
...
export const DEFAULT_TOKENS: Tokens = {
  ...
  dividerColors: DEFAULT_LIGHT_DIVIDER_COLORS,
  spinnerColors: DEFAULT_LIGHT_SPINNER_COLORS,
  avatarColors: DEFAULT_LIGHT_AVATAR_COLORS,
  badgeColors: DEFAULT_LIGHT_BADGE_COLORS,
  progressBarColors: DEFAULT_LIGHT_PROGRESS_BAR_COLORS,
  dialogColors: DEFAULT_LIGHT_DIALOG_COLORS,
  sliderColors: DEFAULT_LIGHT_SLIDER_COLORS,
...
export const DEFAULT_DARK_TOKENS: Tokens = {
  ...
  dividerColors: DEFAULT_DARK_DIVIDER_COLORS,
  spinnerColors: DEFAULT_DARK_SPINNER_COLORS,
  avatarColors: DEFAULT_DARK_AVATAR_COLORS,
  badgeColors: DEFAULT_DARK_BADGE_COLORS,
  progressBarColors: DEFAULT_DARK_PROGRESS_BAR_COLORS,
  dialogColors: DEFAULT_DARK_DIALOG_COLORS,
  sliderColors: DEFAULT_DARK_SLIDER_COLORS,
