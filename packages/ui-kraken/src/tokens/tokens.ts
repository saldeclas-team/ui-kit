...
import {
  ...
  flattenSpinnerColors,
  flattenAvatarColors,
  flattenBadgeColors,
  flattenProgressBarColors,
  flattenDialogColors,
  flattenSliderColors,
...
export function buildConfig(light: Tokens = DEFAULT_TOKENS, dark: Tokens = DEFAULT_DARK_TOKENS) {
  ...
  const tokens = createTokens({
    ...
    color: {
      ...
      ...flattenSpinnerColors(lightResolved.spinnerColors),
      ...flattenAvatarColors(lightResolved.avatarColors),
      ...flattenBadgeColors(lightResolved.badgeColors),
      ...flattenProgressBarColors(lightResolved.progressBarColors),
      ...flattenDialogColors(lightResolved.dialogColors),
      ...flattenSliderColors(lightResolved.sliderColors),
  ...
  return createTamagui({
    ...
    themes: {
      ...
      dark: {
        ...
        ...flattenSpinnerColors(darkResolved.spinnerColors),
        ...flattenAvatarColors(darkResolved.avatarColors),
        ...flattenBadgeColors(darkResolved.badgeColors),
        ...flattenProgressBarColors(darkResolved.progressBarColors),
        ...flattenDialogColors(darkResolved.dialogColors),
        ...flattenSliderColors(darkResolved.sliderColors),
