...
const meta = {
  title: "UI Kit/SelectBottomSheet",
...
type ControlledProps = Omit<
  React.ComponentProps<typeof SelectBottomSheet<Country>>,
...
export const WithHelperText: Story = {
  render: () => (
    <Controlled label="Country" helperText="Drag down or tap the backdrop to dismiss." />
  ),
};
...
export const WithSheetTitle: Story = {
  render: () => <Controlled label="Country" sheetTitle="Choose your country" />,
};

export const CustomSnapPoint: Story = {
  render: () => <Controlled label="Country" snapPoints={["30%"]} />,
};
